 ...
 * @author lgome
 */
public class EspecialidadeUICadastrar extends javax.swing.JDialog {

    /**
     * Creates new form EspecialidadeUI
     */
    public EspecialidadeUICadastrar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtNomeEspecialidade, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EspecialidadeUICadastrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EspecialidadeUICadastrar dialog = new EspecialidadeUICadastrar(new javax.swing.JFrame(), true);
